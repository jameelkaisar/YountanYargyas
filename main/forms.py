...
class MyRegistrationForm(UserCreationForm):
    ...
    username = forms.CharField(widget=forms.TextInput(attrs={"autocapitalize": "none", "autocomplete": "off", "maxlength": "150", "autofocus": "autofocus"}), label="Username")
...
class AddClass(forms.ModelForm):
    class Meta:
        ...
        widgets = {"student_class": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "class_summary": forms.Textarea(attrs={"class": "materialize-textarea"})}
...
class AddSubject(forms.ModelForm):
    class Meta:
        ...
        widgets = {"student_subject": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "subject_summary": forms.Textarea(attrs={"class": "materialize-textarea"}), "student_class": forms.HiddenInput()}
...
class AddChapter(forms.ModelForm):
    class Meta:
        ...
        widgets = {"student_chapter": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "chapter_summary": forms.Textarea(attrs={"class": "materialize-textarea"}), "student_subject": forms.HiddenInput()}
...
class AddCategory(forms.ModelForm):
    class Meta:
        ...
        widgets = {"student_category": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "category_summary": forms.Textarea(attrs={"class": "materialize-textarea"}), "category_image": forms.FileInput(attrs={"style": "display: none;", "accept": "image/*"})}
...
class AddContent(forms.ModelForm):
    class Meta:
        ...
        widgets = {"student_content": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "content_text": TinyMCE(), "content_file": forms.FileInput(attrs={"style": "display: none;"}), "content_category": forms.HiddenInput()}
...
class AddImage(forms.ModelForm):
    class Meta:
        ...
        widgets = {"image_name": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "image_summary": forms.Textarea(attrs={"class": "materialize-textarea"}), "image_file": forms.FileInput(attrs={"style": "display: none;", "accept": "image/*"})}
...
class AddAudio(forms.ModelForm):
    class Meta:
        ...
        widgets = {"audio_name": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "100"}), "audio_summary": forms.Textarea(attrs={"class": "materialize-textarea"}), "audio_file": forms.FileInput(attrs={"style": "display: none;", "accept": "audio/*"})}
...
class EditClass(forms.Form):
    ...
    student_class = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Class Name", max_length=100)
...
class EditSubject(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    student_subject = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Subject Name", max_length=100)
...
class EditChapter(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    student_chapter = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Chapter Name", max_length=100)
...
class EditSection(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    student_section = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Section Name", max_length=100)
...
class EditStudentCategory(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    student_category = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Category Name", max_length=100)
...
class EditStudentContent(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    student_content = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Category Name", max_length=100)
...
class EditImage(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    image_name = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Image Name", max_length=100)
...
class EditAudio(forms.Form):
    ...
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    audio_name = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Audio Name", max_length=100)
...
class NewChat(forms.Form):
    chat_recipient = forms.CharField(widget=forms.TextInput(attrs={"class": "autocomplete", "autocomplete": "off"}), label="Username", max_length=150)
...
class AddNotification(forms.ModelForm):
    class Meta:
        ...
        widgets = {"notif_title": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "500"}), "notif_text": forms.Textarea(attrs={"class": "materialize-textarea"}), "notif_file": forms.FileInput(attrs={"style": "display: none;"})}

class EditNotification(forms.Form):
    data_id = forms.CharField(widget=forms.HiddenInput())
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    notif_title = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Title", max_length=500)
...
class AddHelpSection(forms.ModelForm):
    class Meta:
        ...
        widgets = {"help_title": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "500"}), "help_text": forms.Textarea(attrs={"class": "materialize-textarea"}), "help_video": forms.FileInput(attrs={"style": "display: none;", "accept": "video/*"})}

class EditHelpSection(forms.Form):
    data_id = forms.CharField(widget=forms.HiddenInput())
    data_type = forms.CharField(widget=forms.HiddenInput())
    data_next = forms.CharField(widget=forms.HiddenInput())
    help_title = forms.CharField(widget=forms.TextInput(attrs={"autocomplete": "off"}), label="Title", max_length=500)
